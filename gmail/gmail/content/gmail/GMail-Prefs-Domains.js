var gGMailDomains = 
{
    ...
    init: function ()
    {
        try
        {
            ...
            this.m_DebugLog.Write("GMail-Prefs-Domains : init - START");
            
            this.m_strBundle = document.getElementById("stringsGMailPrefs-Domains");
            
            this.m_UriManager = Components.classes["@mozilla.org/GMailDomains;1"]
                                          .getService()
        ...
        {
            DebugDump("GMail-Prefs-Domains : Exception in init : " 
                                           + err.name + 
                                           ".\nError message: " 
                                           + err.message + "\n"
                                           + err.lineNumber);
    ...
    updateList : function ()
    {
        try
        {
            this.m_DebugLog.Write("GMail-Prefs-Domains : updateList - Start");         
            ...
            this.m_DebugLog.Write("GMail-Prefs-Domains : updateList - END");
        }
        catch(err)
        {
             this.m_DebugLog.DebugDump("GMail-Prefs-Domains : Exception in updateList : " 
                                           + err.name + 
                                           ".\nError message: " 
                                           + err.message + "\n"
                                           + err.lineNumber);   
    ...
    clearList : function ()
    {
        try
        {
            this.m_DebugLog.Write("GMail-Prefs-Domains : clearList - START");   
            
            //get selected item
            var listView = document.getElementById("listDomain");   //click item
            var iIndex = listView.selectedIndex;
            this.m_DebugLog.Write("GMail-Prefs-Domains : clearList - iIndex "+iIndex);
            
            if (iIndex != -1)
            {
                var item = listView.getItemAtIndex(iIndex);
                this.m_szSelectedDomain = item.getAttribute("id");
                this.m_DebugLog.Write("GMail-Prefs-Domains : clearList - m_szSelectedDomain  "+this.m_szSelectedDomain ); 
            }
            ...
            this.m_DebugLog.Write("GMail-Prefs-Domains : clearList - END");  
        }
        catch(err)
        {
             this.m_DebugLog.DebugDump("GMail-Prefs-Domains : Exception in clearList : " 
                                           + err.name + 
                                           ".\nError message: " 
                                           + err.message + "\n"
                                           + err.lineNumber);   
    ...
    domainList : function (szDomain , bDefault)
    {
        ...
        image.setAttribute("id","GMailImage");
        ...
        newItem.setAttribute("ondblclick","gGMailDomains.onDBclick();");
        
        list.appendChild(newItem);
               
        this.m_DebugLog.Write("GMail-Prefs-Domains : domainList - END");        
    },
    ...
    errorList : function ()
    {
        this.m_DebugLog.Write("GMail-Prefs-Domains : errorList - START");   
        ...
        this.m_DebugLog.Write("GMail-Prefs-Domains : errorList - END");
    },
    ...
    add : function ()
    {
        try
        {
            this.m_DebugLog.Write("GMail-Prefs-Domains : add - START");
            ...
            this.m_DebugLog.Write("GMail-Prefs-Domains : add - result "+ oResult.value);
            if (oResult.value)
            {
            ...
            this.m_DebugLog.Write("GMail-Prefs-Domains : add - END");
        }
        catch(err)
        {
             this.m_DebugLog.DebugDump("GMail-Prefs-Domains : Exception in add : " 
                                           + err.name + 
                                           ".\nError message: " 
                                           + err.message + "\n"
                                           + err.lineNumber);   
    ...
    edit : function ()
    {
        try
        {
            this.m_DebugLog.Write("GMail-Prefs-Domains : edit - START");
            
            var listView = document.getElementById("listDomain");   //click item
            var iIndex = listView.selectedIndex;
            this.m_DebugLog.Write("GMail-Prefs-Domains : edit - iIndex "+iIndex);
            if (iIndex == -1) return;
  
            var item = listView.getItemAtIndex(iIndex);
            var szDomain = item.getAttribute("id");
            this.m_DebugLog.Write("GMail-Prefs-Domains : edit -  " + szDomain);                      
            ...
            this.m_DebugLog.Write("GMail-Prefs-Domains : edit - result "+ oResult.value);
            if (oResult.value)
            {
                this.m_DebugLog.Write("GMail-Prefs-Domains : edit - szDomains "+ oData.szDomain + " " + oData.szURL);
            ...
            this.m_DebugLog.Write("GMail-Prefs-Domains : edit - END"); 
        }
        catch(err)
        {
             this.m_DebugLog.DebugDump("GMail-Prefs-Domains : Exception in add : " 
    ...
    remove : function ()
    {
        try
        {
            this.m_DebugLog.Write("GMail-Prefs-Domains : remove - START");
            
            //get selected item
            var listView = document.getElementById("listDomain");   //click item
            var iIndex = listView.selectedIndex;
            this.m_DebugLog.Write("GMail-Prefs-Domains : remove - iIndex "+iIndex);
            if (iIndex == -1) return;
        ...
        {
            this.m_DebugLog.DebugDump("GMail-Prefs-Domains : Exception in remove : " 
                                           + err.name + 
                                           ".\nError message: " 
                                           + err.message + "\n"
                                           + err.lineNumber);
    ...
    onDBclick : function ()
    {
        ...
        {
            this.m_DebugLog.DebugDump("GMail-Prefs-Domains : Exception in ondbclick : " 
                                           + err.name + 
                                           ".\nError message: " 
                                           + err.message + "\n"
                                           + err.lineNumber);
    ...
    onSelect : function ()
    {
        try
        {
            this.m_DebugLog.Write("GMail-Prefs-Domains : onSelect - START");
            ...
            this.m_DebugLog.Write("GMail-Prefs-Domains : onSelect - END");
        }
        catch(err)
        {
            this.m_DebugLog.DebugDump("GMail-Prefs-Domains : Exception in onSelect : " 
                                           + err.name + 
                                           ".\nError message: " 
                                           + err.message + "\n"
                                           + err.lineNumber);
